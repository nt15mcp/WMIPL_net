                        ...
                        foreach ($numbers as $number => $shooters) {
                            if ($s < 6) {
                                ...
                                if (!is_string($shooters)) {
                                    ...
                                    echo '<td><button class="w3-button w3-bar-item" onclick="dummy(\'' . $shooter .'_'.$match_completed. '\')" >Dummy Out Shooter</button></td>';
                                } else {
                                    if (is_string($shooters)) {
                                    ...
                                    echo '<td><button class="w3-button w3-bar-item" onclick="dummy(\'' . $shooters.'_'.$match_completed. '\')" >Dummy Out Shooter</button></td>';
                                }
                                $s++;
                            }
...
<script type="text/javascript">
    ...
    */
    ...
    function dummy(name) {
        fetch("includes/dummy-shooter.inc.php", {
            "method": "POST",
            "headers": { "content-type": "application/json" },
